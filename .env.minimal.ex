...
SOURCE_EXTRACTION_CONCURRENCY_LIMIT=4
...
SEMANTIC_CANDIDATE_TIMEOUT_SECONDS=15
SEMANTIC_CANDIDATE_EMBEDDING_BATCH_SIZE=4
SEMANTIC_CANDIDATE_TEXT_CHARS=2000
SEMANTIC_CANDIDATE_MAX_CHUNKS=3
...
EMBEDDING_MAX_INPUT_CHARS=4000
EMBEDDING_SLOW_REQUEST_WARNING_SECONDS=10
