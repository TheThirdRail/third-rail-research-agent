...
def test_analysis_crew_includes_rhetoric_task_and_five_task_pipeline():
    ...
    assert "return [source_task, bias_task, fact_task, rhetoric_task, report_task]" in content
